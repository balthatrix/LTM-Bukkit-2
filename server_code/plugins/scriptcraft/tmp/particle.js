...
//}/Users/k0d1g0sys/CS/Thoughtstem/LTM-Cloud/build/instances_deploy/server_code/plugins/scriptcraft/tmp/particle.js
//
...
//    server.getPluginManager().getPlugin("ThoughtStem").playParticle(null, effect[0], loc);
...
//        ReflectionUtil.setValue(packet, "a", server.getPluginManager().getPlugin("ThoughtStem").flame);
