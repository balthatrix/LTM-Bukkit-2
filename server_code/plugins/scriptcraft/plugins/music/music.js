...
var flatten = function(tone_obj) {
    tone_obj.note = org.bukkit.Note.flattened(tone_obj.note);
    return tone_obj;
}

var sharpen = function(tone_obj) {
    tone_obj.note = org.bukkit.Note.sharped(tone_obj.note);
    return tone_obj;
}
...
var playTune = function(tempo, player_to_play_to) {
   ...
   var TSJAR = server.getPluginManager().getPlugin("ThoughtStem");
