...
//    FileWriter = java.io.FileWriter;
  ...
  var _save = function( object, filename ) {
    ...
    f = (filename instanceof java.io.File) ? filename : new java.io.File(filename);
    out = new java.io.PrintWriter(new java.io.FileWriter(f));
   ...
   */
  var configFile = new java.io.File(jsPluginsRootDir, 'data/');
  configFile.mkdirs();
  configFile = new java.io.File(configFile,'global-config.json');
   ...
   */
  (function(){
    var jsonFileReader = new java.io.FileReader( new java.io.File( jsPluginsRootDirName + '/lib/json2.js' ) );
  ...
  var armorstand = require('armorstand');
  ...
  global.schematics = schematics;
  global.citizens = citizens;
  ...
  plugins.autoload( global, new java.io.File(jsPluginsRootDir,'plugins'), logger );
    /*
  ...
  (function(){
    var cbPluginsDir = jsPluginsRootDir.parentFile,
      cbDir = new java.io.File(cbPluginsDir.canonicalPath).parentFile,
      legacyExists = false,
      legacyDirs = [new java.io.File( cbDir, 'js-plugins' ),
                    new java.io.File( cbDir, 'scriptcraft' )];
